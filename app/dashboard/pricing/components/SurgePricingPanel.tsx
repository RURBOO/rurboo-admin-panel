...
import { MapPin, TrendingUp, Save, Plus, Trash2 } from "lucide-react"

export function SurgePricingPanel() {
    const [surgeActive, setSurgeActive] = useState(false)
    const [zones, setZones] = useState([
        { id: 1, name: "Downtown Core", multiplier: 1.5, radiusKm: 5, active: true },
        { id: 2, name: "Airport Terminal", multiplier: 2.0, radiusKm: 2, active: false }
    ])

    const handleSave = () => {
        alert("Surge configurations saved successfully to Firebase!")
    }
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card className="border-dashed flex flex-col items-center justify-center p-6 text-muted-foreground hover:bg-secondary/50 hover:text-foreground transition-colors cursor-pointer min-h-[250px]">
